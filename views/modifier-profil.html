...
<head>
  ...
  <title>Modifier Profil - DigitalRDV</title>
...
<body>
    <nav class="navbar navbar-expand-lg bg-light navbar-success  m-6 shadow-custom ">
        <div class="container">
          <a href="#" class="navbar-brand"><img src="images/logo.png" alt="" width="50"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
                <a class=" navbar nav-link ml-5" href="accueil.html">Accueil</a>
              </li>
              <li class="nav-item">
                <a class=" navbar nav-link ml-5" href="rendezvous.html">Prendre rendez-vous</a>
              </li>
              <li class="nav-item">
                <a class="navbar nav-link ml-5" href="mes-rendez-vous.html"> Mes rendez-vous</a>
              </li>
            </ul>
      
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="navbar nav-link font-weight-bold " href="login.html">Se connecter <img src="images/icon1.png" alt="" width="25px"></a>
              </li>
            </ul>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8 profile-form">
        <div class="form-title">Modifier mes informations</div>
        <form action="#" method="post">
          <div class="form-group">
            <label for="nom">Nom complet</label>
            <input type="text" class="form-control" id="nom" name="nom" value="Hayrana El Fassi" required>
          </div>
          <div class="form-group">
            <label for="email">Adresse email</label>
            <input type="email" class="form-control" id="email" name="email" value="hayrana@email.com" required>
          </div>
          <div class="form-group">
            <label for="tel">Téléphone</label>
            <input type="tel" class="form-control" id="tel" name="tel" value="+212600000000">
          </div>
          <div class="form-group">
            <label for="adresse">Adresse</label>
            <input type="text" class="form-control" id="adresse" name="adresse" value="Rabat, Maroc">
          </div>
          <button type="submit" class="btn btn1 mt-3">Enregistrer</button>
          <a href="profil.html" class="btn btn-secondary mt-3 ml-2">Annuler</a>
        </form>
      </div>
    </div>
  </div>
      ...
      <footer class="bg-light text-center text-lg-start" >
        <div class="container p-4">
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
              <h5 style="color: rgb(21,194,159);">Contactez-nous</h5>
              <p>
            ...
            Réseaux sociaux
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
              <h5 style="color: rgb(21,194,159);">Suivez-nous</h5>
              ...
              <a href="#" class="mr-3">
                <img src="images/linkden.png" alt="LinkedIn" width="30">
              </a>
            </div>
        ...
        <div class="text-center p-3" style="background-color: rgb(21,194,159); color: white;">
