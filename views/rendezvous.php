...
<body>
    ...
    <div class="container">
        ...
        <div class="step active" id="step1">
            ...
            <div class="buttons">
                ...
                <button class="next-btn" onclick="nextStep()" id="info-next">Suivant</button>
            </div>
        </div>
        ...
        <div class="step" id="step2">
            ...
            <div class="buttons">
                <button class="back-btn" onclick="prevStep()">Retour</button>
                <button class="next-btn" onclick="nextStep()" id="date-next" disabled>Suivant</button>
            </div>
        </div>
        ...
        <div class="step" id="step3">
            ...
            <div class="buttons">
                <button class="back-btn" onclick="prevStep()">Retour</button>
                <button class="next-btn" onclick="nextStep()" id="time-next" disabled>Confirmer</button>
            </div>
        </div>
        ...
        <div class="step" id="step4">
            ...
            <div class="confirmation">
                ...
                <div class="confirmation-details">
                    ...
                    <p><strong>Téléphone:</strong> <span id="confirm-phone"></span></p>
            ...
            <div class="buttons">
                <button class="back-btn" onclick="resetForm()">Nouveau rendez-vous</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function generateCalendar() {
            ...
            document.getElementById('month-year').textContent = new Date(year, month, 1).toLocaleDateString('fr-FR', { month: 'long', year: 'numeric' });
            
            // Déterminer le premier jour du mois (0 = dimanche, 1 = lundi, etc.)
            let firstDayOfMonth = new Date(year, month, 1).getDay();
            if (firstDayOfMonth === 0) firstDayOfMonth = 7; // Convertir dimanche (0) en 7 pour l'adapter à notre grille qui commence par lundi
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                if (checkDate < today) {
                    ...
                    dayElement.onclick = function() { selectDate(this, day); };
                }
        ...
        function selectDate(element, day) {
            ...
            const year = currentDate.getFullYear();
            const month = currentDate.getMonth();
            selectedDate = new Date(year, month, day).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' });
            
            // Activer le bouton suivant
            document.getElementById('date-next').disabled = false;
        }
        
        // Fonction pour sélectionner un horaire
