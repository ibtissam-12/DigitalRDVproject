...
try {
    ...
    if ($userInfo->aud !== $client_id) {
        echo json_encode(['success' => false, 'message' => 'Connexion Google invalide']);
        exit;
    }
    ...
    echo json_encode([
        'success' => true,
        'redirect' => ($userInfo->email === 'dr.john@clinic.com') ? 'doctor-dashboard.php' : 'patient-dashboard.php'
    ]);

} catch (Exception $e) {
    echo json_encode(['success' => false, 'message' => 'Échec de la connexion Google']);
}
?>